...
public class TodosSQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "comments_db.db"; //the db name
	private static final int DATABASE_VERSION = 2; //the version. to upgrade, simply up the version and it'll blow away existing data. 
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		Log.w(TodosSQLiteHelper.class.getName(),
